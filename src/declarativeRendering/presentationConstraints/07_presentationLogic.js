  ...
  render() {
    ...
    return (
      <form className="result-box" noValidate onSubmit={this.submit}>
        ...
        <div className="form-group">
          {this.state.address === '' &&
            <p className="help-block help-block-red">You have to specify your address</p>
          }
          {this.state.telephone === '' &&
            <p className="help-block help-block-red">You have to specify your telephone number</p>
          }
...
const data = {
  ...
  article: {
    title: "Alternative für ngSwitch, ngIf, ngShow, ngHide, ngDisable, ngReadonly",
    codeSnippets: [{
      name: "code.js",
      lang: "js",
      code:
`class PresentationLogic extends React.Component {
  ...
  render() {
    ...
    angularLink: "ang-ngSwitch,ngIf,ngShow,ngHide,ngDisable,ngReadonly",
    migrationCheckData: {
      info: [
        {
          change: "ngSwitch",
