...
<div class="form-group">
	...
	<input type="password" name="passwordInput" ng-model="user.pass" class="form-control" id="userPassword" placeholder="Password">
	<p class="help-block" ng-bind="'Your password is: ' + user.pass"></p>
</div>
<div class="form-group">
	<label for="userCountry">Country</label>
	<select class="form-control" name="select" id="userCountry" ng-model="user.country" ng-options="country.name for country in countries">
	</select>
</div>
<div class="checkbox">
	<label>
