...
const data = {
    ...
    codeSnippets: [{
        ...
        lang:"js",
        code:
`controller('PresentationLogicCtrl', ['$scope', function($scope) {
	$scope.user = {
		email: 'user@mail.com',
		address: '',
		telephone: '',
		...
		<div ng-switch on="selected">
			<div ng-switch-when="address">
				<div class="form-group">
					...
					<input type="text" name="addressInput" ng-model="user.address" class="form-control" id="userAddress" placeholder="Address">
			...
			<div ng-switch-when="telephone">
				<div class="form-group">
					...
					<input type="text" name="telephoneInput" ng-model="user.telephone" class="form-control" id="userTelephone" placeholder="Telephone">
			...
			<div ng-switch-when="birthday">
				<div class="form-group">
					...
					<input type="text" name="birthdayInput" ng-model="user.birthday" class="form-control" id="userBirthday" placeholder="Birthday">
...
<div class="form-group">
	...
	<input id="submitBtn" name="submitBtn" type="submit" class="btn btn-default" ng-disabled="!canProceed" value="Proceed">
</div>
</form>`
    }],
        templateUrl: 'angularjs/declarativeRendering/presentationConstraints/presentaionLogic/presentationlogic.html',
        reactLink: "react-ngSwitchngIfngShowngHidengDisablengReadonly"
    }
};
    return function() {
    return data;
